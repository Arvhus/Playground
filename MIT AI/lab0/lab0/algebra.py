...
# True
# >>> isinstance(Sum([1,2,3]), Expression) # Sums and Products are both
# Expressions
# True
...
class Sum(list, Expression):
    ...
    def simplify(self):
        ...
        if len(terms) == 1:
            ...
            return Sum(
                [simplify_if_possible(term) for term in terms]).flatten()
...
def do_multiply(expr1, expr2):
    ...
    * expr1 is a Product, and expr2 is a Product
    ...
    '*' will not help you.
    """
    # this bit copied off https://github.com/TensorDuck/mit_ocw_ai/tree/master/hw0
    # simply put didn't understand nature of input
